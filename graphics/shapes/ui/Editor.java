...
public class Editor extends JFrame
{
	...
	{	
		...
		this.buildModel();
		SRectangle test = new SRectangle(new Rectangle(100,100,60,30));
		test.addAttribute(new ColorAttributes(true,Color.CYAN, true, Color.RED));
		test.addAttribute(new SelectionAttributes(true));
		this.sview = new ShapesView(test);
